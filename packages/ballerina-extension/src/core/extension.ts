...
import {
    ...
    ENABLE_EXPERIMENTAL_FEATURES, ENABLE_NOTEBOOK_DEBUG, ENABLE_RUN_FAST, ENABLE_LOCAL_CENTRAL_SEARCH,
...
export class BallerinaExtension {
    ...
    */
    ...
    public enabledLocalCentralSearch(): boolean {
        return <boolean>workspace.getConfiguration().get(ENABLE_LOCAL_CENTRAL_SEARCH);
    }
